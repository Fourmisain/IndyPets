	...
	public List<AbstractConfigListEntry> get(String i13n, Field field, Object config, Object defaults, GuiRegistryAccess registry) {
		...
		return Collections.singletonList(
			ConfigEntryBuilder.create()
				.startIntSlider(new TranslatableText("text.autoconfig.indypets.option.innerHomePercentage"), currentValue, 0, 100)
				.setTooltip(new TranslatableText("text.autoconfig.indypets.option.innerHomePercentage.@Tooltip"))
